...
int main(int c, char** args) {
  ...
  //newComms1.initConnection(UDP_LINK, 1338, "127.0.0.1");
  newComms2.initConnection(UDP_LINK, 1338, "127.0.0.1");
  

  //newComms1.addAddress(1, "127.0.0.1", 1338);
  newComms2.addAddress(1, "127.0.0.1", 1337);
	...
	//newComms1.run();
	  ...
	  while (true)
	  {
		  if (newComms2.recv(sourceID, messageID, buffer, messageLength))
		  {
			  printf("FOUND\n");
		  }
		  Sleep(100);
		//  newComms1.send(1, 1, buf, 10);
	  }
