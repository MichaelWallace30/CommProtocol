...
#ifndef __CSHARP_CONNECTION_STATE_H
#define __CSHARP_CONNECTION_STATE_H
...
*/
public ref class ConnectionState
{
public:
...
private:
  ...
  */
  Diagnostics::Stopwatch^ lastSyncPackSentTimer;
  ...
  */
  int numUnansweredCheckConnectRequests;

  Threading::Mutex^ checkConnectRequestMutex;
  ...
  */
  Diagnostics::Stopwatch^ lastCheckConnectReplySentTimer;

  Threading::Mutex^ checkConnectReplyMutex;
  ...
  */
  ...
  /**
  Prevents thread from reading ping while it is being modified by another thread.
  */
...
#endif //__CSHARP_CONNECTION_STATE_H
